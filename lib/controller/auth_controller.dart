...
class AuthController extends GetxController {
  ...
  void signUp(
    ...
    if (result.statusCode == 200) {
      ...
      print("token signup: $token");
      print("fullName signup: $fullName");
      ...
      if (userResult.statusCode == 200) {
        ...
        EasyLoading.showError('Something wrong. Try again!11111111111');
      }
    } else {
      EasyLoading.showError('Something wrong. Try again! 22222222222');
    }
  }
